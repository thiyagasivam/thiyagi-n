...
<title>Canada Holidays 2025 | Complete Calendar | National & Provincial Holidays</title>
<meta name="description" content="Complete Canada Holiday Calendar 2025. Find all national holidays, provincial holidays, statutory holidays, and observances across all Canadian provinces and territories.">
<meta name="keywords" content="Canada holidays 2025, Canadian holidays, statutory holidays Canada, provincial holidays, national holidays Canada, Victoria Day, Canada Day, Thanksgiving">
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <span class="text-gray-500">/</span>
            <span class="text-gray-900 font-medium">Canada Holidays 2025</span>
        </div>
    </div>
</nav>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-6">
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What are the federal statutory holidays in Canada 2025?</h3>
