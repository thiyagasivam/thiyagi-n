...
<title>Indiana Holidays 2025 | Complete Calendar | State & Federal Holidays | Festivals</title>
<meta name="description" content="Complete Indiana Holiday Calendar 2025. Find all state holidays, federal holidays, cultural events, and observances. Plan your year with our comprehensive holiday guide.">
<meta name="keywords" content="Indiana holidays 2025, Indiana state holidays, US federal holidays, Indiana festivals, Indiana calendar, holidays Indiana, festival dates 2025">
    ...
    <nav class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center space-x-2 py-3 text-sm">
                ...
                <i class="fas fa-chevron-right text-gray-400"></i>
                <span class="text-gray-600 font-medium">Indiana Holidays 2025</span>
            </div>
        </div>
    </nav>

<?php
// Indiana Holidays 2025 Data
$holidays_2025 = array (
  '2025-01-01' => 
  array (
    'name' => 'New Year\'s Day',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-4xl font-bold"><div class="flex items-center space-x-3">
                        ...
                        <span>Indiana Holidays 2025</span>
                    </div></h1>
...
<main class="container mx-auto px-4 py-8">
    ...
    <section class="mb-8 bg-white rounded-lg p-6 border-l-4 border-state-primary shadow-lg">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-3xl font-bold text-gray-800 mb-4">Complete Indiana Holiday Calendar 2025</h2>
            <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                Welcome to the comprehensive Indiana Holiday Calendar 2025! Plan your year with our up-to-date calendar including all federal holidays, state-specific celebrations, and cultural observances.
            </p>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-6">
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What are the main state holidays in Indiana 2025?</h3>
