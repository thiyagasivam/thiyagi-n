...
<head>
    ...
    <title>Goa Holidays 2025 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Goa Holiday Calendar 2025. Find all major festivals, national holidays, cultural events, and religious celebrations in Goa. Plan your year with our comprehensive guide.">
    <meta name="keywords" content="Goa holidays 2025, Goa festivals, Shigmo, Carnival, national holidays India, cultural events Goa, Goa calendar, holidays Goa, festival dates 2025">
    <meta name="author" content="Goa Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Goa Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Goa Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FF4500/FFFFFF?text=Goa+Holidays+2025">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Goa Holidays 2025">
    <meta name="twitter:description" content="Complete Goa Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Goa Holidays 2025",
        "description": "Complete Goa Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Goa in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Goa in 2025 include Carnival (February 25 - March 1), Shigmo (March 13), and Feast of St. Francis Xavier (December 3)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Goa 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Goa 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2025) is celebrated with great patriotic fervor in Goa. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Goa in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-blue-50 to-green-100 min-h-screen">
    ...
    $holidays_2025 = [
        ...
        '2025-02-25' => [ // Carnival Monday - Approximate date
        ...
        '2025-02-26' => [ // Carnival Tuesday - Approximate date
        ...
        '2025-02-27' => [ // Carnival Wednesday - Approximate date
        ...
        '2025-03-13' => [ // Shigmo - Approximate date (Full Moon)
            'name' => 'Shigmo',
            'type' => 'Goa Festival',
        ...
        '2025-12-03' => [ // Feast of St. Francis Xavier - Approximate date
    ...
    $bank_holidays_2025 = [
        ...
        '2025-03-01' => [ // Carnival Saturday - Approximate date
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Goa Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Goa Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'Goa Festival'; })); ?></div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main festivals in Goa in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Goa in 2025 include <strong>Carnival</strong> (February 25 - March 1) - a vibrant Portuguese-influenced festival,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Goa 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Goa observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Shigmo</strong> (March 13, 2025) is Goa's biggest spring festival, celebrating the harvest season.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Goa, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            The most prominent is the <strong>Feast of St. Francis Xavier</strong> (December 3, 2025), the patron saint of Goa.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2025) is a public holiday in Goa. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor in Goa.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated with great enthusiasm in Goa,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Goa to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Goa in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Goa Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'goa-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Goa Holidays 2025',
                    text: 'Check out the Goa holiday calendar for 2025!',
