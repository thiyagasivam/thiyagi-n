...
<head>
    ...
    <title>West Bengal Holidays 2025 | Complete Calendar | Durga Puja | National Holidays</title>
    <meta name="description" content="Complete West Bengal Holiday Calendar 2025. Find all major festivals like Durga Puja, Poila Boishakh, Janmashtami, national holidays, cultural events, and religious celebrations. Plan your year with our comprehensive holiday guide.">
    <meta name="keywords" content="West Bengal holidays 2025, Durga Puja, Poila Boishakh, Janmashtami, national holidays India, cultural events West Bengal, West Bengal calendar, holidays West Bengal, festival dates 2025">
    <meta name="author" content="West Bengal Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="West Bengal Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete West Bengal Holiday Calendar 2025 with all festivals like Durga Puja, Poila Boishakh, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FF0000/FFFFFF?text=West+Bengal+Holidays+2025">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="West Bengal Holidays 2025">
    <meta name="twitter:description" content="Complete West Bengal Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "West Bengal Holidays 2025",
        "description": "Complete West Bengal Holiday Calendar 2025 with all festivals like Durga Puja, Poila Boishakh, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in West Bengal in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in West Bengal in 2025 include Durga Puja (October 2-6), Poila Boishakh (April 14), Janmashtami (August 26), and Rabindra Jayanti (May 7)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in West Bengal 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in West Bengal 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    <?php
    // West Bengal Holidays 2025 Data
    $holidays_2025 = [
        '2025-01-01' => [
            'name' => 'New Year\'s Day',
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>West Bengal Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete West Bengal Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive West Bengal Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main festivals in West Bengal in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in West Bengal in 2025 include <strong>Durga Puja</strong> (October 2-6) - the biggest and most significant festival,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-flag text-red-500"></i>
                            <span>How many national holidays are there in West Bengal 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            West Bengal observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Poila Boishakh</strong> (April 14, 2025) marks the Bengali New Year. It's a vibrant celebration involving traditional foods like 'panta ilish' and 'muri',
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in West Bengal, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Rabindra Jayanti</strong> (May 7, 2025) celebrates the birth anniversary of Nobel laureate Rabindranath Tagore.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor across West Bengal.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated with great enthusiasm in West Bengal,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across West Bengal to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to West Bengal in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `West Bengal Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'west-bengal-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'West Bengal Holidays 2025',
                    text: 'Check out the West Bengal holiday calendar for 2025!',
