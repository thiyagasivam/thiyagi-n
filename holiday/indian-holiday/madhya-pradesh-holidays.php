...
<head>
    ...
    <title>Madhya Pradesh Holidays 2025 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Madhya Pradesh Holiday Calendar 2025. Find all major festivals, national holidays, cultural events, and religious celebrations in Madhya Pradesh. Plan your year with our comprehensive guide.">
    <meta name="keywords" content="Madhya Pradesh holidays 2025, MP festivals, Gwalior Dussehra, Ujjain Simhastha, Khajuraho Festival, national holidays India, cultural events MP, Madhya Pradesh calendar, holidays Madhya Pradesh, festival dates 2025">
    <meta name="author" content="Madhya Pradesh Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Madhya Pradesh Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Madhya Pradesh Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/228B22/FFFFFF?text=Madhya+Pradesh+Holidays+2025"> <!-- Forest Green -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Madhya Pradesh Holidays 2025">
    <meta name="twitter:description" content="Complete Madhya Pradesh Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Madhya Pradesh Holidays 2025",
        "description": "Complete Madhya Pradesh Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Madhya Pradesh in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Madhya Pradesh in 2025 include Gwalior Dussehra (October 1-10), Ujjain Simhastha/Kumbh Mela (May 11-June 9), and Khajuraho Dance Festival (February 20-28)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Madhya Pradesh 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Madhya Pradesh 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2025) is celebrated with great patriotic fervor in Madhya Pradesh. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Madhya Pradesh in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-blue-50 to-green-100 min-h-screen">
    <?php
    // Madhya Pradesh Holidays 2025 Data
    ...
    $holidays_2025 = [
        ...
        '2025-02-20' => [ // Khajuraho Dance Festival start - Approximate date
        ...
        '2025-02-28' => [ // Khajuraho Dance Festival end - Approximate date
        ...
        '2025-05-11' => [ // Ujjain Simhastha start - Approximate date (May-June)
        ...
        '2025-06-09' => [ // Ujjain Simhastha end - Approximate date
        ...
        '2025-10-01' => [ // Gwalior Dussehra start - Approximate date (October)
        ...
        '2025-10-10' => [ // Gwalior Dussehra end - Approximate date
    ...
    $bank_holidays_2025 = [
        ...
        '2025-09-24' => [ // Vijaya Dashami/Dussehra - Approximate date (General)
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Madhya Pradesh Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Madhya Pradesh Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Madhya Pradesh Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-green-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'MP Festival'; })); ?></div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-dragon text-orange-500"></i> <!-- Dragon icon -->
                            <span>What are the main festivals in Madhya Pradesh in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Madhya Pradesh in 2025 include <strong>Gwalior Dussehra</strong> (October 1-10) - a 10-day grand celebration,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Madhya Pradesh 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Madhya Pradesh observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Ujjain Simhastha</strong> (May-June 2025) is one of the four <em>Kumbh Melas</em> held in India, occurring in Ujjain.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Madhya Pradesh, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Makar Sankranti</strong> (January 14, 2025) marks the sun's transition into the zodiac sign of Capricorn (Makar).
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2025) is a public holiday in Madhya Pradesh. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor in Madhya Pradesh.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated with enthusiasm in Madhya Pradesh,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Madhya Pradesh to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Madhya Pradesh in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Madhya Pradesh Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'madhya-pradesh-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Madhya Pradesh Holidays 2025',
                    text: 'Check out the Madhya Pradesh holiday calendar for 2025!',
