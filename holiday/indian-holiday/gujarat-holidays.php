...
<head>
    ...
    <title>Gujarat Holidays 2025 | Complete Calendar | Gujarat Festivals | National Holidays</title>
    <meta name="description" content="Complete Gujarat Holiday Calendar 2025. Find all Gujarat festivals, national holidays, cultural events, and religious celebrations. Plan your year with our comprehensive holiday guide.">
    <meta name="keywords" content="Gujarat holidays 2025, Gujarat festivals, Navratri, Uttarayan, national holidays India, Gujarat cultural events, Gujarat calendar, holidays Gujarat, festival dates 2025">
    <meta name="author" content="Gujarat Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Gujarat Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Gujarat Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FFA500/FFFFFF?text=Gujarat+Holidays+2025"> <!-- Orange placeholder -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Gujarat Holidays 2025">
    <meta name="twitter:description" content="Complete Gujarat Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Gujarat Holidays 2025",
        "description": "Complete Gujarat Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main Gujarat festivals in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main Gujarat festivals in 2025 include Navratri (September 29 - October 8), Uttarayan (January 14), and Rann Utsav (November - February)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Gujarat 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Gujarat 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Navratri is one of the most significant festivals in Gujarat, celebrated twice a year (Chaitra and Ashwin months). The Ashwin Navratri (September/October 2025) is the more prominent one, known for its vibrant Garba and Dandiya Raas dances."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2025) is celebrated with great patriotic fervor across Gujarat. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Gujarat in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-blue-50 to-green-100 min-h-screen"> <!-- Changed background -->
    ...
    $holidays_2025 = [
        ...
        '2025-02-24' => [ // Maha Shivratri - Approximate date
            'name' => 'Maha Shivratri',
            'type' => 'Religious',
        ...
        '2025-07-17' => [ // Bakrid/Eid al-Adha - Approximate date
        ...
        '2025-09-23' => [ // Maha Navami - Approximate date
            'name' => 'Maha Navami',
            'type' => 'Religious',
    ...
    $bank_holidays_2025 = [
        '2025-01-13' => [ // Uttarayan Eve - Approximate date
            'name' => 'Uttarayan Eve',
            'type' => 'Bank Holiday',
        ...
        '2025-01-15' => [ // Uttarayan Holiday - Approximate date
        ...
        '2025-07-17' => [ // Muharram - Approximate date (Same as Bakrid here, but might be different)
            'name' => 'Muharram',
            'type' => 'Bank Holiday',
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Gujarat Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Gujarat Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Gujarat Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'Gujarat Festival'; })); ?></div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main Gujarat festivals in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main Gujarat festivals in 2025 include <strong>Navratri</strong> (September 29 - October 8) - the world-famous nine-night dance festival,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Gujarat 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Gujarat observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Uttarayan</strong> (January 14, 2025), also known as Makar Sankranti, marks the sun's transition into the northern hemisphere.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Navratri</strong> (September 29 - October 8, 2025) is a nine-night festival dedicated to the worship of the Divine Feminine.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Gujarat, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Rann Utsav</strong> (November 2025 - February 2026) is a unique cultural festival held in the Great Rann of Kutch.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2025) is a public holiday in Gujarat. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor across Gujarat.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated with great enthusiasm in Gujarat,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Gujarat to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Gujarat in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Gujarat Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'gujarat-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Gujarat Holidays 2025',
                    text: 'Check out the Gujarat holiday calendar for 2025!',
