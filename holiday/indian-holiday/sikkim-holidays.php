...
<head>
    ...
    <title>Sikkim Holidays 2025 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Sikkim Holiday Calendar 2025. Find all major festivals, national holidays, cultural events, and religious celebrations. Plan your year with our comprehensive holiday guide.">
    <meta name="keywords" content="Sikkim holidays 2025, Sikkim festivals, Losar, Saga Dawa, Dasain, Tendong Hill Fair, national holidays India, cultural events Sikkim, Sikkim calendar, holidays Sikkim, festival dates 2025">
    <meta name="author" content="Sikkim Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Sikkim Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Sikkim Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/4B0082/FFFFFF?text=Sikkim+Holidays+2025">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Sikkim Holidays 2025">
    <meta name="twitter:description" content="Complete Sikkim Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Sikkim Holidays 2025",
        "description": "Complete Sikkim Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Sikkim in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Sikkim in 2025 include Losar (Tibetan New Year, approximate date), Saga Dawa (Buddha's birth/death/parinirvana, approximate date), Dasain (Great Festival, approximate date), and Loshar (approximate date)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Sikkim 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Sikkim 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2025) is celebrated with great patriotic fervor across Sikkim. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs showcasing Sikkim's diversity."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Sikkim in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    // Bank Holidays 2025 - Additional holidays specific to banks (often align with major festivals)
    $bank_holidays_2025 = [
        '2025-01-15' => [
            'name' => 'Bank Holiday',
            'type' => 'Bank Holiday',
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Sikkim Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Sikkim Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Sikkim Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 hover:shadow-md transition-all">
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-blue-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'Buddhist Festival'; })); ?></div>
                        </div>
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200 hover:shadow-md transition-all">
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-purple-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'Sikkim State Festival'; })); ?></div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main festivals in Sikkim in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Sikkim in 2025 include <strong>Losar</strong> (Tibetan New Year, approximate date),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Sikkim 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Sikkim observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Sikkim, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor across Sikkim.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated with enthusiasm in Sikkim,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Sikkim to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Sikkim in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Sikkim Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'sikkim-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Sikkim Holidays 2025',
                    text: 'Check out the Sikkim holiday calendar for 2025!',
