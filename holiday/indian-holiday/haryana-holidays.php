...
<head>
    ...
    <title>Haryana Holidays 2025 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Haryana Holiday Calendar 2025. Find all major festivals, national holidays, cultural events, and religious celebrations in Haryana. Plan your year with our comprehensive guide.">
    <meta name="keywords" content="Haryana holidays 2025, Haryana festivals, Teej, Gangaur, national holidays India, cultural events Haryana, Haryana calendar, holidays Haryana, festival dates 2025">
    <meta name="author" content="Haryana Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Haryana Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Haryana Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/006400/FFFFFF?text=Haryana+Holidays+2025"> <!-- Dark Green -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Haryana Holidays 2025">
    <meta name="twitter:description" content="Complete Haryana Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Haryana Holidays 2025",
        "description": "Complete Haryana Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Haryana in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Haryana in 2025 include Teej (August 15), Gangaur (March 25), and Lohri (January 13)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Haryana 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Haryana 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2025) is celebrated with great patriotic fervor in Haryana. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs and parades."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Haryana in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-green-50 to-blue-100 min-h-screen">
    ...
    $holidays_2025 = [
        ...
        '2025-01-13' => [ // Lohri - Approximate date (Winter Solstice)
            'name' => 'Lohri',
        ...
        '2025-01-14' => [ // Maghi - Day after Lohri
            'name' => 'Maghi',
            'type' => 'Haryana Festival',
        ...
        '2025-03-25' => [ // Gangaur - Approximate date (Phalgun Shukla Trayodashi)
            'name' => 'Gangaur',
            'type' => 'Haryana Festival',
        ...
        '2025-08-15' => [ // Teej - Approximate date (Shravan Krishna Paksha)
            'name' => 'Teej',
            'type' => 'Haryana Festival',
    ...
    $bank_holidays_2025 = [
        ...
        '2025-03-01' => [ // Holi - Approximate date
            'name' => 'Holi',
            'type' => 'Bank Holiday',
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Haryana Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 border-l-4 border-green-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Haryana Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Haryana Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'Haryana Festival'; })); ?></div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main festivals in Haryana in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Haryana in 2025 include <strong>Teej</strong> (August 15) - a vibrant festival for women,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Haryana 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Haryana observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Lohri</strong> (January 13, 2025) is a significant harvest festival in Haryana, celebrated in January.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Gangaur</strong> (March 25, 2025) is a major festival dedicated to Goddess Gauri (Parvati), primarily celebrated by women in Haryana.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Haryana, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Teej</strong> (August 15, 2025) is a festival dedicated to Goddess Parvati, celebrated with great enthusiasm by married women in Haryana.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2025) is a public holiday in Haryana. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor in Haryana.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated in Haryana, especially in areas with significant Christian populations
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Haryana to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Haryana in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Haryana Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'haryana-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Haryana Holidays 2025',
                    text: 'Check out the Haryana holiday calendar for 2025!',
