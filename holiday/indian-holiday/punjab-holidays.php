...
<head>
    ...
    <title>Punjab Holidays 2025 | Complete Calendar | Punjabi Festivals | National Holidays</title>
    <meta name="description" content="Complete Punjab Holiday Calendar 2025. Find all Punjabi festivals, national holidays, cultural events, and religious celebrations. Plan your year with our comprehensive holiday guide.">
    <meta name="keywords" content="Punjab holidays 2025, Punjabi festivals, Baisakhi, Lohri, national holidays India, Punjabi cultural events, Punjab calendar, holidays Punjab, festival dates 2025">
    <meta name="author" content="Punjab Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Punjab Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Punjab Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FFD700/000000?text=Punjab+Holidays+2025">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Punjab Holidays 2025">
    <meta name="twitter:description" content="Complete Punjab Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Punjab Holidays 2025",
        "description": "Complete Punjab Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main Punjabi festivals in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main Punjabi festivals in 2025 include Lohri (January 13), Maghi (January 14), Baisakhi (April 14), and Guru Nanak Jayanti (November 5)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Punjab 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Punjab 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Baisakhi, celebrated on April 14, 2025, is one of the most important festivals in Punjab. It marks the Sikh New Year and commemorates the formation of the Khalsa Panth by Guru Gobind Singh in 1699. It's also a harvest festival."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2025) is celebrated with great patriotic fervor across Punjab. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs and parades."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Punjab in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    // Bank Holidays 2025 - Additional holidays specific to banks (can overlap with main holidays)
    $bank_holidays_2025 = [
    ...
    $all_holidays_2025 = array_merge($bank_holidays_2025, $holidays_2025);
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Punjab Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Punjab Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Punjab Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 hover:shadow-md transition-all">
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'Punjabi Festival'; })); ?></div>
                        </div>
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200 hover:shadow-md transition-all">
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-purple-600"><?php echo count(array_filter($all_holidays_2025, function($h) { return $h['type'] === 'Sikh Festival'; })); ?></div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-fire text-orange-500"></i>
                            <span>What are the main Punjabi festivals in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main Punjabi festivals in 2025 include <strong>Lohri</strong> (January 13) - a winter harvest festival,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Punjab 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Punjab observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Baisakhi</strong>, celebrated on April 14, 2025, is one of the most important festivals in Punjab.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Lohri</strong> (January 13, 2025) is a popular winter festival, especially in North India, and is
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Punjab, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Guru Nanak Jayanti</strong> (November 5, 2025) celebrates the birth anniversary of Guru Nanak Dev Ji,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor across Punjab.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated in Punjab, especially in areas with
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Punjab to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Punjab in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Punjab Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'punjab-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Punjab Holidays 2025',
                    text: 'Check out the Punjab holiday calendar for 2025!',
