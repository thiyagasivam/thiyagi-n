...
<head>
    ...
    <title>Telangana Holidays 2025 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Telangana Holiday Calendar 2025. Find all state festivals like Bathukamma, Bonalu, national holidays, cultural events, and religious celebrations. Plan your year with our comprehensive holiday guide.">
    <meta name="keywords" content="Telangana holidays 2025, Bathukamma, Bonalu, Sankranti, national holidays India, cultural events Telangana, Telangana calendar, holidays Telangana, festival dates 2025">
    <meta name="author" content="Telangana Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Telangana Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Telangana Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FF8C00/FFFFFF?text=Telangana+Holidays+2025">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Telangana Holidays 2025">
    <meta name="twitter:description" content="Complete Telangana Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Telangana Holidays 2025",
        "description": "Complete Telangana Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Telangana in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Telangana in 2025 include Bathukamma (dates vary by month), Bonalu (July/August), Sankranti (January 14-15), and Dasara (October)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Telangana 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Telangana 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                ...
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Telangana in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    // Bank Holidays 2025 - Additional holidays specific to banks (includes major religious festivals)
    $bank_holidays_2025 = [
        '2025-01-28' => [
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Telangana Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Telangana Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Telangana Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'State Festival'; })); ?></div> <!-- Changed filter -->
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main festivals in Telangana in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Telangana in 2025 include <strong>Bathukamma</strong> (dates vary by month, usually Navratri),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Telangana 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Telangana observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Bonalu</strong> (July/August 2025) is a popular Hindu festival dedicated to Goddess Mahankali,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Telangana, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Sankranti</strong> (Makara Sankranti) is celebrated with great enthusiasm in Telangana on January 14th, 2025.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor across Telangana.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated with great enthusiasm in Telangana,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Telangana to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Telangana in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Telangana Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'telangana-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Telangana Holidays 2025',
                    text: 'Check out the Telangana holiday calendar for 2025!',
