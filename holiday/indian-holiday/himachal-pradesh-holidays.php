...
<head>
    ...
    <title>Himachal Pradesh Holidays 2025 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Himachal Pradesh Holiday Calendar 2025. Find all major festivals, national holidays, cultural events, and religious celebrations in Himachal Pradesh. Plan your year with our comprehensive guide.">
    <meta name="keywords" content="Himachal Pradesh holidays 2025, HP festivals, Lohri, Himachal New Year, national holidays India, cultural events HP, Himachal Pradesh calendar, holidays Himachal Pradesh, festival dates 2025">
    <meta name="author" content="Himachal Pradesh Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Himachal Pradesh Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Himachal Pradesh Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FF4500/FFFFFF?text=Himachal+Pradesh+Holidays+2025">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Himachal Pradesh Holidays 2025">
    <meta name="twitter:description" content="Complete Himachal Pradesh Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Himachal Pradesh Holidays 2025",
        "description": "Complete Himachal Pradesh Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Himachal Pradesh in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Himachal Pradesh in 2025 include Lohri (January 13), Himachal Pradesh Foundation Day (April 15), and Minjar Mela (July 27)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Himachal Pradesh 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Himachal Pradesh 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Lohri is a major winter festival celebrated in Himachal Pradesh, especially in the Kangra and Bilaspur regions, on January 13, 2025. It marks the end of winter and the beginning of longer days, celebrated with bonfires, folk songs, and traditional dances."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2025) is celebrated with great patriotic fervor in Himachal Pradesh. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Himachal Pradesh in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-blue-50 to-green-100 min-h-screen">
    <?php
    // Himachal Pradesh Holidays 2025 Data
    ...
    $holidays_2025 = [
        ...
        '2025-03-14' => [ // Holi - Approximate date
            'name' => 'Holi',
            'type' => 'Religious',
        ...
        '2025-06-06' => [ // Eid al-Fitr - Approximate date
            'name' => 'Eid al-Fitr',
            'type' => 'Religious',
        ...
        '2025-07-27' => [ // Minjar Mela - Approximate date (Chamba)
            'name' => 'Minjar Mela',
            'type' => 'HP Festival',
    ...
    $bank_holidays_2025 = [
        ...
        '2025-03-01' => [ // Shivratri - Approximate date
            'name' => 'Maha Shivratri',
            'type' => 'Bank Holiday',
        ...
        '2025-04-05' => [ // Good Friday - Approximate date
            'name' => 'Good Friday',
            'type' => 'Bank Holiday',
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Himachal Pradesh Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Himachal Pradesh Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Himachal Pradesh Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'HP Festival'; })); ?></div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main festivals in Himachal Pradesh in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Himachal Pradesh in 2025 include <strong>Lohri</strong> (January 13) - a vibrant winter festival,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Himachal Pradesh 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Himachal Pradesh observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Lohri</strong> (January 13, 2025) is a major winter festival celebrated in Himachal Pradesh, especially in the Kangra and Bilaspur regions.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Himachal Pradesh Foundation Day</strong> (April 15, 2025) commemorates the day Himachal Pradesh became a full-fledged state of India in 1971.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Himachal Pradesh, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Minjar Mela</strong> (July 27, 2025) is one of the most important festivals in Himachal Pradesh, primarily celebrated in <strong>Chamba</strong>.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2025) is a public holiday in Himachal Pradesh. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor in Himachal Pradesh.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated with great enthusiasm in Himachal Pradesh,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Himachal Pradesh to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Himachal Pradesh in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Himachal Pradesh Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'himachal-pradesh-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Himachal Pradesh Holidays 2025',
                    text: 'Check out the Himachal Pradesh holiday calendar for 2025!',
