...
<head>
    ...
    <title>Odisha Holidays 2025 | Complete Calendar | Odia Festivals | National Holidays</title>
    <meta name="description" content="Complete Odisha Holiday Calendar 2025. Find all Odia festivals, national holidays, cultural events, and religious celebrations. Plan your year with our comprehensive holiday guide.">
    <meta name="keywords" content="Odisha holidays 2025, Odia festivals, Rath Yatra, Durga Puja, Raja Parba, national holidays India, Odia cultural events, Odisha calendar, holidays Odisha, festival dates 2025">
    <meta name="author" content="Odisha Holiday Calendar">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Odisha Holidays 2025 - Complete Calendar">
    <meta property="og:description" content="Complete Odisha Holiday Calendar 2025 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FF8C00/FFFFFF?text=Odisha+Holidays+2025"> <!-- Changed color -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Odisha Holidays 2025">
    <meta name="twitter:description" content="Complete Odisha Holiday Calendar 2025 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Odisha Holidays 2025",
        "description": "Complete Odisha Holiday Calendar 2025 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main Odia festivals in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main Odia festivals in 2025 include Rath Yatra (June 23), Durga Puja (October 1-5), and Raja Parba (June 13-15)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Odisha 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Odisha 2025 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Rath Yatra, held in 2025 on June 23, is one of the most important festivals in Odisha, celebrated at the Jagannath Temple in Puri. It involves the ceremonial procession of Lord Jagannath, Balabhadra, and Subhadra on massive chariots."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2025) is celebrated with great patriotic fervor across Odisha. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Odisha in 2025?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-blue-50 to-green-100 min-h-screen"> <!-- Changed background gradient -->
    ...
    $holidays_2025 = [
        ...
        '2025-03-21' => [ // Approximate date for Holi
            'name' => 'Holi',
            'type' => 'Religious',
        ...
        '2025-06-13' => [ // Raja Parba Start - Approximate date
        ...
        '2025-06-14' => [ // Raja Parba Day 2 - Approximate date
        ...
        '2025-06-15' => [ // Raja Parba End - Approximate date
        ...
        '2025-06-23' => [ // Rath Yatra - Approximate date
            'name' => 'Rath Yatra',
            'type' => 'Odisha Festival',
        ...
        '2025-07-21' => [ // Ganesh Chaturthi - Approximate date
        ...
        '2025-10-24' => [ // Durga Puja - Approximate date (starts)
        ...
        '2025-10-28' => [ // Durga Puja - Approximate date (ends)
    ...
    $bank_holidays_2025 = [
        ...
        '2025-04-07' => [ // Easter Monday - Approximate date
            'name' => 'Easter Monday',
            'type' => 'Bank Holiday',
            'description' => 'Christian religious holiday - Banks closed',
            'icon' => 'fa-university',
        ...
        '2025-06-24' => [ // Rath Yatra Holiday - Approximate date
        ...
        '2025-07-07' => [ // Rath Yatra Snana Yatra - Approximate date
            'name' => 'Snana Yatra',
            'type' => 'Bank Holiday',
        ...
        '2025-08-11' => [ // Eid al-Adha/Bakrid - Approximate date
        ...
        '2025-10-29' => [ // Diwali - Approximate date
            'name' => 'Diwali',
            'type' => 'Bank Holiday',
        ...
        '2025-10-30' => [ // Diwali Holiday - Approximate date
            'name' => 'Diwali Holiday',
            'type' => 'Bank Holiday',
        ...
        '2025-11-06' => [ // Chhat Puja - Approximate date
            'name' => 'Chhat Puja',
            'type' => 'Bank Holiday',
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Odisha Holidays 2025</span>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6 border-l-4 border-blue-500"> <!-- Changed background -->
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Odisha Holiday Calendar 2025</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Odisha Holiday Calendar 2025! This detailed guide provides you with all the important dates,
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2025, function($h) { return $h['type'] === 'Odisha Festival'; })); ?></div>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-om text-red-500"></i> <!-- Changed icon and color -->
                            <span>What are the main Odia festivals in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main Odia festivals in 2025 include <strong>Rath Yatra</strong> (June 23) - the famous chariot festival at Puri,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Odisha 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Odisha observes several national holidays in 2025 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Rath Yatra</strong> (June 23, 2025) is one of the most important festivals in Odisha, celebrated at the Jagannath Temple in Puri.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Raja Parba</strong> (June 13-15, 2025) is a unique three-day festival in Odisha that celebrates the onset of the monsoon season and womanhood.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2025) are celebrated in Odisha, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Odisha Day</strong> (April 1, 2025), also known as <strong>Utkal Divas</strong>, commemorates the formation of Odisha as a separate province in 1936.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2025) is a public holiday in Odisha. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2025) is celebrated with great patriotic fervor across Odisha.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2025) is celebrated with great enthusiasm in Odisha,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2025) is celebrated across Odisha to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Odisha in 2025?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Odisha Holidays 2025
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'odisha-holidays-2025.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Odisha Holidays 2025',
                    text: 'Check out the Odisha holiday calendar for 2025!',
