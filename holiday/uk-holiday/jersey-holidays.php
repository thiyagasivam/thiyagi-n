<?php 
// Jersey Holidays 2025 - Page specific head content
$page_title = "Jersey Holidays 2025 - Complete Calendar & Bank Holidays | 25+ Years Experience";
$page_description = "Complete Jersey Holiday Calendar 2025 with all bank holidays, cultural events, and observances. Professional holiday planning guide with 25+ years of expertise. Plan your year with our comprehensive Jersey holiday directory.";
$page_keywords = "Jersey holidays 2025, Jersey bank holidays, UK holidays, Jersey festivals, Jersey calendar, holidays Jersey, festival dates 2025, 25 years experience";
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Jersey Holidays 2025</span>
        </div>
    </div>
</nav>

<?php
// Jersey Holidays 2025 Data
$holidays_2025 = array (
  '2025-01-01' => 
  array (
    'name' => 'New Year\'s Day',
    ...
    <div class="container mx-auto px-4 py-6 relative z-10">
        <div class="flex items-center justify-between">
            ...
            <span class="text-red-600 font-bold text-xs">JE</span>
                        ...
                        <span>Jersey Holidays 2025</span>
                    </div></h1>
