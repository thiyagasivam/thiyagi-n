<?php 
// Oxford Holidays 2025 - Page specific head content
...
<title>Oxford Holidays 2025 | Complete Calendar | Local Events | Bank Holidays</title>
<meta name="description" content="Complete Oxford Holiday Calendar 2025. Find all bank holidays, local events, festivals, and observances. Plan your year with our comprehensive Oxford holiday guide.">
<meta name="keywords" content="Oxford holidays 2025, Oxford events, Oxford festivals, England holidays, Oxford calendar">
<style>
:root {
    --city-primary: #003366;
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Oxford Holidays 2025</span>
        </div>
    </div>
</nav>

<?php
// Oxford Holidays 2025 Data
$holidays_2025 = array (
  '2025-01-01' => 
  array (
    'name' => 'New Year\'s Day',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <h1 class="text-4xl font-bold">Oxford Holidays 2025</h1>
                    </div>
                    <p class="text-lg opacity-90">Oxfordshire â€¢ Bank Holidays â€¢ Local Events â€¢ Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Frideswide â€¢ Lord Mayor of Oxford</p>
                </div>
            </div>
