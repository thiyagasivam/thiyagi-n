<?php 
// Plymouth Holidays 2025 - Page specific head content
...
<title>Plymouth Holidays 2025 | Complete Calendar | Local Events | Bank Holidays</title>
<meta name="description" content="Complete Plymouth Holiday Calendar 2025. Find all bank holidays, local events, festivals, and observances. Plan your year with our comprehensive Plymouth holiday guide.">
<meta name="keywords" content="Plymouth holidays 2025, Plymouth events, Plymouth festivals, England holidays, Plymouth calendar">
<style>
:root {
    --city-primary: #000080;
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Plymouth Holidays 2025</span>
        </div>
    </div>
</nav>

<?php
// Plymouth Holidays 2025 Data
$holidays_2025 = array (
  '2025-01-01' => 
  array (
    'name' => 'New Year\'s Day',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <h1 class="text-4xl font-bold">Plymouth Holidays 2025</h1>
                    </div>
                    <p class="text-lg opacity-90">Devon â€¢ Bank Holidays â€¢ Local Events â€¢ Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Andrew â€¢ Lord Mayor of Plymouth</p>
                </div>
            </div>
