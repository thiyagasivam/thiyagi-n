...
if (!$bankInfo) {
    ...
    error_log("Missing bank slug in personal loan calculator: " . $bankSlug);
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                        ...
                        <?php echo $bankName; ?> Personal Loan Information
                    </h3>
                ...
                <div class="grid md:grid-cols-2 gap-8 mb-8">
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            <?php echo $bankName; ?> is a leading <?php echo strtolower($bankType); ?> offering competitive personal loan products. 
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Our <?php echo $bankName; ?> EMI calculator helps you plan your personal loan effectively. 
