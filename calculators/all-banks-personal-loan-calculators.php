...
$lenders = [
    'Private Banks' => [
        'hdfc-bank' => ['name' => 'HDFC Bank', 'rate' => '10.50% - 24.00%'],
        'icici-bank' => ['name' => 'ICICI Bank', 'rate' => '10.75% - 19.00%'],
        'axis-bank' => ['name' => 'Axis Bank', 'rate' => '11.00% - 22.00%'],
        'kotak-mahindra-bank' => ['name' => 'Kotak Mahindra Bank', 'rate' => '10.99% - 20.00%'],
        'yes-bank' => ['name' => 'YES Bank', 'rate' => '11.50% - 18.00%'],
        'bandhan-bank' => ['name' => 'Bandhan Bank', 'rate' => '12.00% - 23.00%'],
        'csb-bank' => ['name' => 'CSB Bank', 'rate' => '11.75% - 21.00%'],
        'city-union-bank' => ['name' => 'City Union Bank', 'rate' => '12.50% - 22.00%'],
        'dcb-bank' => ['name' => 'DCB Bank', 'rate' => '13.00% - 24.00%'],
        'dhanlaxmi-bank' => ['name' => 'Dhanlaxmi Bank', 'rate' => '12.75% - 23.50%'],
        'federal-bank' => ['name' => 'Federal Bank', 'rate' => '11.50% - 20.00%'],
        'indusind-bank' => ['name' => 'IndusInd Bank', 'rate' => '11.25% - 22.00%'],
        'idfc-first-bank' => ['name' => 'IDFC FIRST Bank', 'rate' => '10.75% - 19.50%'],
    ...
    'Public Sector Banks' => [
        'state-bank-of-india' => ['name' => 'State Bank of India (SBI)', 'rate' => '11.00% - 15.25%'],
        'punjab-national-bank' => ['name' => 'Punjab National Bank', 'rate' => '11.25% - 17.45%'],
        'bank-of-baroda' => ['name' => 'Bank of Baroda', 'rate' => '11.90% - 19.85%'],
        'bank-of-india' => ['name' => 'Bank of India', 'rate' => '12.00% - 18.50%'],
        'bank-of-maharashtra' => ['name' => 'Bank of Maharashtra', 'rate' => '12.50% - 19.00%'],
        'canara-bank' => ['name' => 'Canara Bank', 'rate' => '11.75% - 18.75%'],
        'central-bank-of-india' => ['name' => 'Central Bank of India', 'rate' => '12.25% - 19.25%'],
        'indian-bank' => ['name' => 'Indian Bank', 'rate' => '11.50% - 18.00%'],
        'indian-overseas-bank' => ['name' => 'Indian Overseas Bank', 'rate' => '12.00% - 19.00%'],
        'punjab-sind-bank' => ['name' => 'Punjab & Sind Bank', 'rate' => '12.75% - 20.00%'],
        'uco-bank' => ['name' => 'UCO Bank', 'rate' => '12.50% - 19.50%'],
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="mb-12 category-section" data-category="<?php echo $category; ?>">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">
                    <?php 
                    $descriptions = [
                        'Private Banks' => 'Leading private sector banks offering competitive personal loan rates and advanced digital services.',
                        'Local Area Banks' => 'Region-specific banks providing personalized banking services with local market expertise.',
                        'Public Sector Banks' => 'Government-owned banks providing reliable personal loan products with attractive interest rates.',
                        'Small Finance Banks' => 'Specialized banks focusing on underserved segments with flexible loan offerings.',
                        'NBFCs' => 'Non-Banking Financial Companies offering quick approval and diverse loan products.',
                        'Fintech Companies' => 'Technology-driven lenders providing instant loans with innovative features.',
                        'Payment Banks' => 'Digital-first banks offering payment services and small-value loans with mobile-centric solutions.',
                        ...
                        'Regional Rural Banks' => 'Government-sponsored rural banks serving farmers, rural artisans, and agricultural laborers with priority sector lending.',
                        'Cooperative Banks' => 'Member-owned financial institutions providing personalized banking services with community focus and competitive rates.',
                        'Foreign Banks' => 'International banks with Indian operations offering premium banking services and global financial solutions.'
                    ];
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="bank-card bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 p-6">
                    <div class="text-center">
                        ...
                        <a href="/calculators/<?php echo $slug; ?>-personal-loan-emi-calculator" 
        ...
        <div class="mt-16 bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800 mb-4">Which bank offers the lowest personal loan interest rate?</h3>
                    <p class="text-gray-600 mb-6">HDFC Bank currently offers one of the lowest starting rates at 10.50% per annum. However, actual rates depend on your credit profile, income, and loan amount.</p>
                    
                    <h3 class="text-xl font-semibold text-gray-800 mb-4">What is the difference between banks and NBFCs?</h3>
                    <p class="text-gray-600 mb-6">Banks are regulated by RBI and offer comprehensive banking services. NBFCs focus on lending and may have more flexible criteria but typically charge higher interest rates.</p>
                </div>
                
                <div>
                    <h3 class="text-xl font-semibold text-gray-800 mb-4">Are fintech loans safe?</h3>
                    <p class="text-gray-600 mb-6">Yes, legitimate fintech companies are regulated by RBI. They offer convenience and speed but may have higher interest rates. Always verify the lender's credentials.</p>
                    
                    <h3 class="text-xl font-semibold text-gray-800 mb-4">How accurate are these EMI calculators?</h3>
                    <p class="text-gray-600 mb-6">Our calculators provide accurate estimates based on standard EMI formulas. Actual rates and fees may vary based on individual profiles and current market conditions.</p>
                </div>
            </div>
        </div>
    </div>
