<?php
// Default values
$defaultPrincipal = 2500000; // 25 lakhs for home loan
$defaultRate = 8.50; // Typical home loan rate
$defaultTenure = 240; // 20 years in months

// General home loan calculator - no bank-specific routing needed
...
// General home loan rate ranges for reference
$generalRateInfo = [
    'minRate' => 8.50,
    'maxRate' => 12.00,
    'defaultRate' => 9.25
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 sticky top-4">
                ...
                <form id="emiForm" class="space-y-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <input type="range" id="principalRange" min="500000" max="50000000" step="100000" value="<?php echo $defaultPrincipal; ?>"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <input type="range" id="tenureRange" min="60" max="360" step="12" value="<?php echo $defaultTenure; ?>"
                ...
                <div id="rateInfo" class="mt-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl border border-purple-200">
                    ...
                    <div class="space-y-2 text-sm text-gray-600">
                        ...
                        <div><strong>Type:</strong> Variable & Fixed Rate Options Available</div>
                    </div>
                </div>
            </div>
        </div>
