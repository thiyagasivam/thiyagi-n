...
<?php
/**
 * MP Electricity Bill Calculator (2025)
 * Single-file PHP solution with Tailwind CSS UI
 */
// MP 2025 Domestic Tariff Slabs
$slab_rates = [
...
<head>
    ...
    <title>MP Electricity Bill Calculator 2025 - Madhya Pradesh Power</title>
    <meta name="description" content="Calculate your Madhya Pradesh electricity bill with the latest 2025 tariff rates for MP Poorv, MP Paschim, and MP Madhya DISCOMs.">
...
<body class="bg-gray-100">
    <div class="max-w-4xl mx-auto px-4 py-8">
        <header class="text-center mb-10">
            <h1 class="text-3xl font-bold text-blue-800 mb-2">Madhya Pradesh Electricity Bill Calculator 2025</h1>
